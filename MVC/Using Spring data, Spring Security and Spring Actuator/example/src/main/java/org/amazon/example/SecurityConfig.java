...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .httpBasic(Customizer.withDefaults()) // Configure Basic Authentication for the API endpoints (like /products)
                .formLogin(form ->
                        form
                                .loginPage("/login")
                ...
                .logout(logout -> logout.permitAll()) //Enable user to logout
                .csrf(csrf -> csrf.disable()); // Disable form login for API endpoints to avoid redirection
        return http.build();
    }
